...
export function ConsultingHero() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={bottomLabelsRef}
        className=" absolute bottom-0 left-5 right-0 lg:mx-0 z-20 lg:w-full w-4/5 px-4 lg:px-8 py-6 bg-linear-to-t from-primary/20 via-primary/10 to-transparent"
      >
        <div className="container mx-auto">
          <div className="grid grid-cols-3 md:grid-cols-3 gap-4 lg:gap-6 lg:mb-10">
            {[
              ...
              >
                <div
                  className={`group w-full text-center px-2 py-2 lg:px-6 lg:py-4 rounded-lg lg:rounded-2xl font-semibold text-sm backdrop-blur-lg transition-all duration-300 ${
                    index === 0
                      ? "bg-white text-gray-600"
                      : "bg-white/25 text-white"
                  }`}
                >
                  <span className="text-[0.5rem] lg:text-lg inline-block group-hover:scale-105 transition-transform">
                    {text}
                  </span>
                </div>
              </div>
